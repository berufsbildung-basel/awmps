...
app.get("/plants", (req, res) => plantController.getPlants(req, res));
app.post("/plants", (req, res) => plantController.postPlant(req, res));
app.put("/plants/:id", (req, res) => plantController.putPlant(req, res));
app.delete("/plants/:id", (req, res) => plantController.deletePlantById(req, res));
